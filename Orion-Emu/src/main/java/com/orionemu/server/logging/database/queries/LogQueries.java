package com.orionemu.server.logging.database.queries;

import com.orionemu.server.boot.Orion;
import com.orionemu.server.logging.AbstractLogEntry;
import com.orionemu.server.logging.database.LogDatabaseHelper;
...
public class LogQueries {
    ...
    public static void updateRoomEntries() {
        ...
        try {
            ...
            preparedStatement.setInt(1, (int) Orion.getTime());
    ...
    public static List<RoomChatLogEntry> getChatlogsByCriteria(int playerId, int roomId, int entryTime, int exitTime) {
        ...
        try {
            ...
            preparedStatement.setInt(2, exitTime == 0 ? (int) Orion.getTime() : exitTime);
