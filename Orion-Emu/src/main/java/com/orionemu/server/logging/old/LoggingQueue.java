...
//import com.orionemu.server.logging.old.objects.TestJSON;
...
//
//public class LoggingQueue implements OrionTask {
//    private final static Logger log = Logger.getLogger(LoggingQueue.class);
//
//    private final String BASE_URL = Configuration.currentConfig().get("orion.game.logging.baseurl");
//
