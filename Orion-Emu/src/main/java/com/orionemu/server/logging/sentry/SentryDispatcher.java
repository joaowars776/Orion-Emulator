package com.orionemu.server.logging.sentry;

public class SentryDispatcher {
//    private static final String SENTRY_DSN = "https://2b04068799c2416a8f02d1bf6294b6a0:041cc030ac334e718fbae0f9c8dc5c8f@sentry.orionproject.com/1";
...
//            return;
//
//        builder.addTag("hotel_name", OrionSettings.hotelName);
//        builder.addTag("hotel_url", OrionSettings.hotelUrl);
//
//        // dispatch the event
