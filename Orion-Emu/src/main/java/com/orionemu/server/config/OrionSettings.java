package com.orionemu.server.config;

import com.orionemu.server.game.rooms.filter.FilterMode;
import com.orionemu.server.storage.queries.config.ConfigDao;
...
public class OrionSettings {
    ...
    public static int maxConnectionsPerIpAddress = 5;
    ...
    public static boolean hallOfFameEnabled = true;
    ...
    private static final Logger log = Logger.getLogger(OrionSettings.class.getName());
