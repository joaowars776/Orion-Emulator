package com.orionemu.server.game.rooms.types.components.types;
...
import com.orionemu.server.game.rooms.types.components.TradeComponent;
...
import com.orionemu.server.network.messages.outgoing.room.trading.*;
...
import com.orionemu.server.storage.queries.items.TradeDao;
...
public class Trade {
    ...
    public void complete() {
        ...
        OrionThreadManager.getInstance().executeOnce(() -> {
