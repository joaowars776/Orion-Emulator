...
import com.orionemu.server.game.rooms.objects.items.types.floor.MagicStackFloorItem;
...
import com.orionemu.server.network.messages.outgoing.room.items.SendWallItemMessageComposer;
...
public class ItemsComponent {
    ...
    private boolean verifyItemTilePosition(FurnitureDefinition item, RoomItemFloor floorItem, RoomTile tile, int rotation) {
        ...
        if (!OrionSettings.roomCanPlaceItemOnEntity) {
