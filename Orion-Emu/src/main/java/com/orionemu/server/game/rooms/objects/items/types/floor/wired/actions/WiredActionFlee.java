...
import com.orionemu.server.game.rooms.objects.items.types.floor.wired.triggers.WiredTriggerCollision;
...
public class WiredActionFlee extends WiredActionItem {
    ...
    private Position random(RoomItemFloor floorItem, Position from) {
        int randomDirection = com.orionemu.server.utilities.RandomInteger.getRandom(0, 3) * 2;
