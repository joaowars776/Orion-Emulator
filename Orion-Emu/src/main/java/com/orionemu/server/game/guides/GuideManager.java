package com.orionemu.server.game.guides;

import com.orionemu.server.game.guides.types.HelpRequest;
import com.orionemu.server.game.guides.types.HelperSession;
import com.orionemu.server.network.messages.outgoing.help.guides.GuideSessionAttachedMessageComposer;
...
public class GuideManager implements Initialisable {
    ...
    public void initialize() {
        OrionThreadManager.getInstance().executePeriodic(this::processRequests, 1000L, 1000L, TimeUnit.MILLISECONDS);
    }
