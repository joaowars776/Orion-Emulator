...
import com.orionemu.server.network.messages.outgoing.music.PlayMusicMessageComposer;
...
public class SoundMachineFloorItem extends RoomItemFloor implements Stateable {
    ...
    public void playNextSong() {
        this.startTimestamp = Orion.getTime();
    ...
    private int timePlaying() {
        return (int) (Orion.getTime() - this.startTimestamp);
    }
