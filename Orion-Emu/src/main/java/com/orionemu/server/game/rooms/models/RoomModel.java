package com.orionemu.server.game.rooms.models;
...
import com.orionemu.server.game.utilities.ModelUtils;
import com.orionemu.server.network.messages.outgoing.room.engine.RelativeHeightmapMessageComposer;
...
public abstract class RoomModel {
    ...
    public RoomModel(String name, String heightmap, int doorX, int doorY, int doorRotation, int wallHeight) throws InvalidModelException {
        ...
        this.ohfGameMap = new byte[this.mapSizeX][this.mapSizeY];
    ...
    protected class InvalidModelException extends Exception {

    }

    public byte[][] getOhfGameMap() {
        return ohfGameMap;
    }
}
