package com.orionemu.server.game.rooms.objects.entities;

import com.orionemu.server.game.rooms.objects.RoomFloorObject;
...
import com.orionemu.server.game.rooms.objects.entities.types.ai.BotAI;
...
public abstract class RoomEntity extends RoomFloorObject implements AvatarEntity {
    ...
    private boolean isOHFWalking = false;
    ...
    public void moveToOHF(int x, int y) {
    ...
    public boolean isOHFWalking() {
        return isOHFWalking;
    }

    public void setOHFWalking(boolean OHFWalking) {
        isOHFWalking = OHFWalking;
    }
