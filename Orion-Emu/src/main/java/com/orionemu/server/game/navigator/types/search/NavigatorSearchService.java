...
import com.orionemu.server.network.messages.outgoing.navigator.updated.NavigatorSearchResultSetMessageComposer;
...
public class NavigatorSearchService implements OrionTask {
...
//        OrionThreadManager.getInstance().executePeriodic(this, 0, 3000, TimeUnit.MILLISECONDS);
    }
