package com.orionemu.server.game.rooms.filter;

import com.orionemu.server.config.OrionSettings;
import com.orionemu.server.storage.queries.filter.FilterDao;
import com.orionemu.server.utilities.FilterUtil;
...
public class WordFilter {
    ...
    public FilterResult filter(String message) {
        ...
        if (OrionSettings.wordFilterMode == FilterMode.STRICT) {
