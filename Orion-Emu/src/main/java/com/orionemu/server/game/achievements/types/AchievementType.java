package com.orionemu.server.game.achievements.types;
...
public enum AchievementType {
    ...
    FASTFOOD_TIMEPLAYED("ACH_BaseJumpDaysPlayed"),
    FASTFOOD_PARACHUTE("ACH_BaseJumpBigParachute"),
    FASTFOOD_SHIELD("ACH_BaseJumpShield"),
    FASTFOOD_WINS("ACH_BaseJumpWins"),
    FASTFOOD_MISSILES("ACH_BaseJumpMissile");
