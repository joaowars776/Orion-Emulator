package com.orionemu.server.game.groups.types.components.forum.threads;
...
public class ForumThread {
    ...
    public void compose(IComposer msg) {
        ...
        msg.writeInt((int) Orion.getTime() - this.getAuthorTimestamp());
        ...
        msg.writeInt((int) Orion.getTime() - this.getMostRecentPost().getAuthorTimestamp());
