package com.orionemu.server.game.rooms.objects.items.types.floor.wired.highscore;
...
import com.orionemu.server.game.rooms.objects.items.types.floor.wired.data.ScoreboardItemData;
...
public class JackpotClassicFloorItem extends RoomItemFloor {

    private boolean state;
    private final ScoreboardItemData itemData;

    public JackpotClassicFloorItem(long id, int itemId, Room room, int owner, String ownerName, int x, int y, double z, int rotation, String data) {
