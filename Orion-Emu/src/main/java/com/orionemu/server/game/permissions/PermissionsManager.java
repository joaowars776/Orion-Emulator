package com.orionemu.server.game.permissions;
...
import com.orionemu.server.storage.queries.permissions.PermissionsDao;
...
public class PermissionsManager implements Initialisable {
    ...
    public void loadRankPermissions() {
        try {
            ...
            this.ranks.put(255, new Rank(255, "Orion", true, 0, false, true, false, false, true, true, true, false, true, true, true, true, true, 10000, true, true));
        } catch (Exception e) {
