...
import com.orionemu.server.game.rooms.objects.items.types.floor.DiceFloorItem;
...
public class WiredActionMatchToSnapshot extends WiredActionItem {
    ...
    public void onEventComplete(WiredItemEvent event) {
        ...
        for (long itemId : this.getWiredData().getSelectedIds()) {
            ...
            if (matchState && !(floorItem instanceof DiceFloorItem || floorItem instanceof HighscoreClassicFloorItem || floorItem instanceof JackpotClassicFloorItem)) {
