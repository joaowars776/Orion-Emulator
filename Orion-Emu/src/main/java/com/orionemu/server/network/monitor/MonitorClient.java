package com.orionemu.server.network.monitor;
...
public class MonitorClient {
    public final String MONITOR_HOST = "monitor.orion.openhabbo.com";
    ...
    public Bootstrap createBootstrap(Bootstrap bootstrap, EventLoopGroup eventLoop) {
        if (bootstrap != null) {
            ...
            bootstrap.remoteAddress(Orion.isDebugging ? "monitor.orion.openhabbo.com" : MONITOR_HOST, MONITOR_PORT);
