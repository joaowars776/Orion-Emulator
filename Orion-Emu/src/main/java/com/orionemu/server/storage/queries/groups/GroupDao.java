package com.orionemu.server.storage.queries.groups;
...
public class GroupDao {
    ...
    public static void save(GroupData groupData) {
        if (groupData.getId() == -1) {
            Orion.getServer().getLogger().warn("Tried to update group data which doesn't exist/doesn't have a valid ID (-1)! Title: " + groupData.getTitle());
            return;
        }
