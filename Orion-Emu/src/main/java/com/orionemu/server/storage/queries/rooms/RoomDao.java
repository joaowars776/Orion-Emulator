package com.orionemu.server.storage.queries.rooms;

import com.orionemu.api.game.rooms.settings.*;
...
public class RoomDao {
    ...
    public static void updateRoom(int roomId, String name, String description, int ownerId, String owner, int category, int maxUsers, RoomAccessType access,
        ...
        try {
            ...
            Orion.getServer().getLogger().error("Failed to save room data" + (e.getMessage().contains("access_type") ? " - Access type: " + access.toString().toLowerCase() : ""));
            SqlHelper.handleSqlException(e);
        } finally {
            SqlHelper.closeSilently(preparedStatement);
            SqlHelper.closeSilently(sqlConnection);
    ...
    public static void getActivePromotions(Map<Integer, RoomPromotion> roomPromotions) {
        ...
        try {
            ...
            preparedStatement = SqlHelper.prepare("SELECT * FROM rooms_promoted WHERE time_expire > " + Orion.getTime(), sqlConnection);
    ...
    public static void deleteExpiredRoomPromotions() {
        ...
        try {
            ...
            preparedStatement = SqlHelper.prepare("DELETE FROM rooms_promoted WHERE time_expire < " + Orion.getTime(), sqlConnection);
