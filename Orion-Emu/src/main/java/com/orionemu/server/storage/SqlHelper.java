...
import com.orionemu.api.messaging.performance.QueryRequest;
        ...
        try {
            ...
            if(queryLogEnabled && queryLog.containsKey(statement.hashCode())) {
                ...
                if(NetworkManager.getInstance().getMessagingClient() != null) {
                    NetworkManager.getInstance().getMessagingClient().sendMessage("com.orionemu:manager", new QueryRequest(log.query, timeTaken));
                }
