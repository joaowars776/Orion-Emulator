package com.orionemu.server.storage.queries.moderation;

import com.orionemu.server.boot.Orion;
import com.orionemu.server.game.moderation.types.Ban;
...
public class BanDao {
    public static Map<String, Ban> getActiveBans() {
        ...
        try {
            ...
            preparedStatement = SqlHelper.prepare("SELECT * FROM bans WHERE expire = 0 OR expire > " + Orion.getTime(), sqlConnection);
