...
public class CacheManager implements Initialisable {
    ...
    public CacheManager() {
        this.enabled = Boolean.parseBoolean((String) Configuration.currentConfig().getOrDefault("orion.cache.enabled", "false"));
        this.keyPrefix = (String) Configuration.currentConfig().getOrDefault("orion.cache.prefix", "orion");
        this.connectionString = (String) Configuration.currentConfig().getOrDefault("orion.cache.connection.url", "");
    }
