package com.orionemu.api.modules;
...
import com.orionemu.api.events.EventListenerContainer;
...
public abstract class BaseModule implements EventListenerContainer {
    ...
    /**
     * The bridge between Orion modules & the main server is the GameService, an object which allows you to
